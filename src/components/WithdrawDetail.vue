      ...
      <div class="modal-content">
        <div class="modal-header">
          <div class="top-header">
            ...
            <div class="modal-title">Ủy nhiệm chi</div>
              ...
              <div class="main-4-5">
                ...
                <div class="row-input">
                  <div class="all-row-input">
                    <div class="label"><b>Lý do chi</b></div>
                    <div class="input" v-if="idPaymentOrReceipt !==undefined">
                      <ComboMainContent
                        :name='txt_description'
...
export default {
  ...
  data() {
    return {
      ...
      dataInsert:{object:null,voucher_code:null,description:null,amount_of_money:0,reason:null,receipt_type:0,employee:null,accounting_date:null,day_voucher:null,address:null,account_get:null},
